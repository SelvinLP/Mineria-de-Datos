...
datamsc
datamsc2 <- datamsc[, c(12,38,48,49,57)]
datamsc2
...
```{r}
ggplot(datamsc2, aes(x = PCP34, y = PCP20_C, color = as.factor(cluster$cluster))) +
  geom_point() +
  geom_point(data = as.data.frame(cluster$centers), aes(x = PCP34, y = PCP20_C), color = "black", size = 4, shape = 17) +
  labs(title = "Estado Conyugal vs País donde estudia",
       x = "PCP34 Estado Conyugal",
